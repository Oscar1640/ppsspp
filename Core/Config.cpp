...
static const ConfigSetting graphicsSettings[] = {
	...
	ConfigSetting("BloomHack", &g_Config.iBloomHack, 2, CfgFlag::PER_GAME | CfgFlag::REPORT),
...
static const ConfigSetting controlSettings[] = {
	...
	ConfigSetting("MouseWheelUpDelayMs", &g_Config.iMouseWheelUpDelayMs, 16, CfgFlag::PER_GAME),
...
#endif
#if defined(USING_WIN_UI)
	ConfigSetting("DisableWinMenu", &g_Config.bDisableWinMenu, false, CfgFlag::DEFAULT),
	ConfigSetting("DisableWinBorders", &g_Config.bDisableWinBorders, false, CfgFlag::DEFAULT),
#endif
